...
`,
		...
		{
			name: "success with github.com/metabd/goimports-reviser/testdata/innderpkg",
			args: args{
				fileData: `package main
import(
	"fmt"
...
`,
				path: "github.com/metabd/goimports-reviser/testdata/innderpkg",
				packageImports: map[string]string{
					"github.com/metabd/goimports-reviser/testdata/innderpkg": "innderpkg",
				},
			},
			want: true,
		},
